...
export function injectReportWorkspaceStyles() {
  ...
  style.textContent = `
    ...
    .report-pdf-panel-content { min-width: 0; min-height: 0; overflow: auto; }
    ...
    .report-page-inspector { display: flex; flex-direction: column; gap: 12px; overflow: auto; background: #f8fafa; }
    ...
    .report-matrix-settings-panel { grid-template-columns: minmax(120px, .7fr) minmax(220px, 1.3fr); gap: 12px 18px; overflow: auto; }
