...
export function injectReportWorkspaceStyles() {
  ...
  style.textContent = `
    ...
    .report-workspace-modal { position: fixed; z-index: 900; inset: 0; padding: 18px; color: #17262b; background: rgba(12, 28, 34, .72); }
    .report-workspace-modal[hidden] { display: none; }
    .report-workspace-shell { position: relative; display: grid; grid-template-rows: 64px minmax(0, 1fr); width: 100%; height: 100%; overflow: hidden; border: 1px solid #aebdc1; border-radius: 6px; background: #edf2f2; box-shadow: 0 24px 70px rgba(3, 18, 23, .42); }
    .report-workspace-shell > header { display: grid; grid-template-columns: minmax(0, 1fr) auto 34px; align-items: center; gap: 18px; padding: 8px 18px; border-bottom: 1px solid #bdc9cc; background: #f8fafa; }
    ...
    .report-workspace-modal button, .report-workspace-modal input, .report-workspace-modal select { min-height: 34px; border: 1px solid #bcc9cc; border-radius: 5px; background: #fff; color: inherit; padding: 6px 9px; font: inherit; }
    .report-workspace-modal button { cursor: pointer; }
    .report-workspace-modal button:hover:not(:disabled) { border-color: #188461; color: #075d43; background: #edf8f4; }
    ...
    .report-filter-row button.is-active { border-color: #087b58; color: #fff; background: #087b58; }
    ...
    .report-page-row.is-selected { color: #075d43; background: #e3f5ee; box-shadow: inset 3px 0 #087b58; }
    ...
    .report-workspace-modal .report-primary-button { display: inline-flex; align-items: center; justify-content: center; gap: 7px; border-color: #087b58; color: #fff; background: #087b58; font-weight: 650; }
    .report-workspace-modal .report-primary-button:hover:not(:disabled) { color: #fff; background: #066c4e; }
    ...
    .report-issue-details li { display: grid; gap: 5px; padding: 9px 10px; border: 1px solid #dec5c2; border-left: 3px solid #b8463b; background: #fff7f5; }
    .report-issue-details li.is-warning { border-color: #dfd1a7; border-left-color: #9a7623; background: #fffaf0; }
    ...
    .report-issue-details span { flex: none; color: #9f332b; font-size: 9px; font-weight: 800; text-transform: uppercase; }
    .report-issue-details .is-warning span { color: #806018; }
    ...
    .report-warning-confirmation { display: grid; grid-template-columns: 1fr 1fr; gap: 7px; padding: 9px; border: 1px solid #dfd1a7; background: #fffaf0; }
    .report-warning-confirmation p { grid-column: 1 / -1; min-height: 0; color: #6f5519; }
    .report-export-failures { max-height: 100px; overflow: auto; margin: 0; padding: 8px 8px 8px 24px; border: 1px solid #dec5c2; background: #fff7f5; color: #7f3029; font-size: 10px; line-height: 1.5; }
    .report-export-overlay { position: absolute; z-index: 10; inset: 0; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 16px; padding: 24px; color: #fff; background: rgba(0, 0, 0, .62); text-align: center; }
