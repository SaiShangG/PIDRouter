...
const pairs: TranslationPair[] = [
  ...
  ['PDF 报告设置', 'PDF report settings'], ['页面设置&导出', 'Page settings & export'],
  ['导出设置', 'Export settings'], ['生成记录', 'Generated files'],
  ['已生成文件', 'Generated files'],
  ['已生成 Matrix', 'Generated matrices'],
  ['尚无 Matrix 生成记录。导出后可在此重新下载。', 'No generated matrices yet. Export one to download it again here.'],
  ...
  ['PDF 正在后台生成，请稍候', 'Generating PDF in the background. Please wait.'],
  ...
  ['Sequence / Phase 范围', 'Sequence / Phase scope'],
  ['搜索 Sequence 或 Phase', 'Search Sequence or Phase'],
  ['搜索 Matrix 范围', 'Search Matrix scope'],
  ['全部选择', 'Select all'], ['全部清除', 'Clear all'],
  ['当前 Sequence', 'Current Sequence'],
  ['未找到匹配的 Sequence 或 Phase', 'No matching Sequence or Phase'],
  ['Matrix 导出设置', 'Matrix export settings'],
  ['输入 Matrix 文件名', 'Enter Matrix filename'],
  ['自定义 Matrix 文件名', 'Custom Matrix filename'],
  ['设备与内容', 'Devices and content'],
  ['包含未激活设备', 'Include inactive devices'],
  ['包含转换条件', 'Include transition conditions'],
  ['导出 Matrix', 'Export matrix'],
  ['下载 Matrix', 'Download matrix'],
  ...
  ['PID 图纸库', 'PID drawing library'], ['关闭图纸库', 'Close drawing library'],
  ['上传 PID', 'Upload PID'], ['文件将直接上传到目标服务器并由后台保存。', 'Files are uploaded directly to and stored by the server.'],
  ['图纸名称', 'Drawing name'], ['图号（可选）', 'Drawing number (optional)'],
  ['文件', 'File'], ['请选择文件', 'Choose a file'], ['正在上传', 'Uploading'], ['上传', 'Upload'],
  ['已上传图纸', 'Uploaded drawings'], ['搜索名称、图号或文件名', 'Search name, drawing number, or filename'],
  ['尚未上传 PID 图纸', 'No PID drawings uploaded'], ['没有匹配的图纸', 'No matching drawings'],
  ['上传者', 'Uploaded by'], ['上传时间', 'Uploaded at'], ['查看图纸', 'View drawing'],
  ['查看解析摘要', 'View parsing summary'], ['重试处理', 'Retry processing'], ['删除图纸', 'Delete drawing'],
  ['上传中', 'Uploading'], ['已上传', 'Uploaded'], ['处理中', 'Processing'], ['可查看', 'Ready'], ['处理失败', 'Failed'],
  ['解析结果摘要', 'Parsing summary'], ['关闭解析详情', 'Close parsing details'],
  ['状态', 'Status'], ['解析完成', 'Parsing completed'], ['Schema 版本', 'Schema version'],
  ['解析器版本', 'Parser version'], ['完成时间', 'Completed at'], ['实体数量', 'Entity count'],
  ['连接数量', 'Connection count'], ['告警数量', 'Warning count'], ['解析告警', 'Parsing warnings'],
  ['未发现解析告警。', 'No parsing warnings found.'],
  ...
  ['Project 描述', 'Project description'], ['输入 Project 描述', 'Enter a Project description'],
  ['选择 PID', 'Select PIDs'], ['包含的 PID', 'Included PIDs'],
  ['搜索 PID 名称、图号或文件名', 'Search PID name, drawing number, or filename'],
  ['图纸库中暂无 PID，请先上传图纸', 'No PIDs in the drawing library. Upload a drawing first.'],
  ['没有匹配的 PID', 'No matching PIDs'], ['尚未关联 PID', 'No PIDs assigned'],
  ['保存更改', 'Save changes'], ['描述', 'Description'], ['无', 'None'], ['包含 PID', 'Included PIDs'],
  ['删除 Project', 'Delete Project'],
  ['后台没有可用的 Project', 'No Projects are available from the server'],
  ['已加载后台 Process 数据', 'Process data loaded from the server'],
  ['后台 API 不可用，未加载本地测试数据', 'The server API is unavailable; local test data was not loaded'],
  ['切换 Project 失败', 'Failed to switch Project'],
  ['后台 API 尚未初始化，无法创建 Process', 'The server API is not initialized; Process cannot be created'],
  ['Process 已保存到后台', 'Process saved to the server'], ['Process 保存失败', 'Failed to save Process'],
  ['Process 已从后台删除', 'Process deleted from the server'], ['Process 删除失败', 'Failed to delete Process'],
  ['Sequence 已保存到后台', 'Sequence saved to the server'], ['Sequence 保存失败', 'Failed to save Sequence'],
  ['Sequence 已更新', 'Sequence updated'], ['Sequence 更新失败', 'Failed to update Sequence'],
  ['Sequence 顺序已更新', 'Sequence order updated'], ['Sequence 排序失败', 'Failed to reorder Sequence'],
  ['Sequence 已复制到后台', 'Sequence copied to the server'], ['Sequence 复制失败', 'Failed to copy Sequence'],
  ['Phase 已复制到后台', 'Phase copied to the server'],
  ['Sequence 已从后台删除', 'Sequence deleted from the server'], ['Sequence 删除失败', 'Failed to delete Sequence'],
  ['上一 Phase 不存在', 'The previous Phase does not exist'], ['历史 Phase 不存在', 'The historical Phase does not exist'],
  ['请选择 DWG 文件', 'Select a DWG file'], ['所选图纸不属于当前 Project', 'The selected drawing does not belong to the current Project'],
  ['所选 Project PID 不存在', 'The selected Project PID does not exist'],
  ['实际后台仅支持上传文件，暂不支持 URL 或空白图纸', 'The server currently supports uploaded files only, not URLs or blank drawings'],
  ['Phase 已从后台删除', 'Phase deleted from the server'], ['Phase 已更新', 'Phase updated'],
  ['Phase 更新失败', 'Failed to update Phase'], ['Phase 顺序已更新', 'Phase order updated'],
  ['Phase 排序失败', 'Failed to reorder Phase'], ['所选 Phase 未关联后台图纸', 'The selected Phase has no server drawing assigned'],
  ['所选 Phase 不是后台图纸', 'The selected Phase does not use a server drawing'],
  ['不支持的图纸关联方式', 'Unsupported drawing source'], ['阶段图纸已保存到后台', 'Phase drawing saved to the server'],
  ['图纸显示名已更新', 'Drawing display name updated'], ['图纸显示名更新失败', 'Failed to update drawing display name'],
  ['没有已启用的 Utility，已应用设备状态但未创建流路高亮', 'No Utility is enabled. Device states were applied without creating a flow-path highlight'],
...
export const translateUiText = (locale: AppLocale, text: string): string => {
  ...
  const dynamic: Array<[RegExp, (match: RegExpMatchArray) => string]> = locale === 'en'
    ? [
      ...
      [/^已切换到 Project：(.+)$/, m => `Switched to Project: ${m[1]}`],
      [/^Phase (\d+) 已保存到后台$/, m => `Phase ${m[1]} saved to the server`],
      ...
      [/^已选择 (\d+) 个 Sequence，(\d+) 个 Phase，(\d+) 类设备$/, m => `${m[1]} Sequences, ${m[2]} Phases, and ${m[3]} device types selected`],
