...
export function injectPhaseWorkspaceStyles() {
  ...
  style.id = STYLE_ID
  style.textContent = `
    .phase-workspace { display: flex; flex-direction: column; height: 100%; min-height: 0; overflow: hidden; color: var(--reference-ink, #152026); background: #f5f8f8; }
    .phase-workspace-content { flex: 1 1 auto; min-height: 0; overflow: auto; padding: 14px; }
    .phase-workspace-block { display: grid; gap: 9px; padding: 12px 0; border-bottom: 1px solid #dbe3e5; }
    ...
    .phase-sequence-group { display: grid; gap: 4px; padding: 5px; border: 1px solid #d8e2e4; border-radius: 6px; background: #fff; }
    .phase-sequence-group.is-active { border-color: #87c8b3; box-shadow: inset 3px 0 #087b58; }
    ...
    .phase-workspace .phase-sequence-toggle:hover:not(:disabled) { border-color: transparent; background: #edf8f4; }
    ...
    .phase-sequence-editor { display: grid; grid-template-columns: 70px minmax(0, 1fr) auto; gap: 6px; padding: 7px; border: 1px solid #d8e2e4; border-radius: 5px; background: #fff; }
    ...
    .phase-count-badge { display: inline-grid; place-items: center; min-width: 21px; height: 20px; padding: 0 6px; border-radius: 10px; color: #53666d; background: #e3eaec; font-size: 10px; font-weight: 750; }
    ...
    .phase-tree-item.is-drag-over .phase-tree-node { border-color: #00a870; box-shadow: 0 0 0 2px rgba(0, 168, 112, .14); }
    ...
    .phase-workspace .phase-tree-node.is-active { border-color: #24a77d; color: #075d43; background: #e1f5ed; box-shadow: inset 3px 0 #087b58; }
    ...
    .phase-overview-identity { display: grid; padding: 10px 11px; border-left: 3px solid #087b58; border-radius: 0 5px 5px 0; background: #eaf5f1; }
    .phase-overview-identity span { color: #087b58; font-size: 10px; font-weight: 800; }
    ...
    .phase-workspace-overview { display: grid; gap: 0; margin: 0; border: 1px solid #d8e2e4; border-radius: 6px; background: #fff; font-size: 12px; }
    ...
    .phase-workspace .phase-overview-delete { justify-self: end; min-width: 28px; width: 28px; min-height: 28px; height: 28px; padding: 0; border-color: #cf7d75; color: #a7352d; background: #fff8f7; }
    .phase-workspace .phase-overview-delete:hover { border-color: #a7352d; color: #8f2d26; background: #fdecea; }
    .phase-overview-statuses { display: flex; flex-wrap: wrap; gap: 5px; }
    .phase-status-badge { padding: 3px 6px; border: 1px solid #c8ddd6; border-radius: 10px; color: #176a50; background: #edf8f4; font-size: 10px; white-space: nowrap; }
